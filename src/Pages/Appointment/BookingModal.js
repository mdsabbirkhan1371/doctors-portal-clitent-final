            ...
            <div class="modal modal-bottom sm:modal-middle">
                <div class="modal-box">
                    ...
                    <form onSubmit={handleForm} className='grid grid-cols-1 gap-3 mt-5 justify-items-center'>
                        ...
                        <input type="text" name='email' placeholder="email address" class="input input-bordered input-accent w-full max-w-xs" />

                        <input type="text" name='phone' placeholder="Your phone number" class="input input-bordered input-accent w-full max-w-xs" />
